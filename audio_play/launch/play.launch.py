...
def generate_launch_description():
    ...
    _dst_launch_arg = DeclareLaunchArgument("dst", default_value="alsasink")
    _device_launch_arg = DeclareLaunchArgument("device", default_value="")
    _do_timestamp_launch_arg = DeclareLaunchArgument("do_timestamp", default_value="false")
    ...
    _depth_launch_arg = DeclareLaunchArgument("depth", default_value="16")
